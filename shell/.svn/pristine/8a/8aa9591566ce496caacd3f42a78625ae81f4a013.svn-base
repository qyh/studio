...
--
-- Host: 192.168.30.10    Database: iforum
-- ------------------------------------------------------
...
INSERT INTO `jforum_bookmarks` VALUES (1,2,1,2,1,'欢迎使用iforums论坛系统','');
...
INSERT INTO `jforum_config` VALUES ('most.users.ever.online','3',1),('most.users.ever.online.date','1333897277943',2);
...
INSERT INTO `jforum_forums` VALUES (1,1,'默认版块','这是一个默认版块',1,3,3,0);
...
INSERT INTO `jforum_groups` VALUES (1,'普通用户','普通用户',0),(2,'管理员','管理员用户',0);
...
INSERT INTO `jforum_karma` VALUES (1,2,2,2,3,5,'2012-04-08 23:02:27');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Users may bid for or sell auction items.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jforum_posts` VALUES (1,1,1,2,'2005-01-04 16:59:54','127.0.0.1',1,0,1,1,NULL,0,1,0,0),(2,2,1,2,'2012-04-08 22:50:53','127.0.0.1',1,0,1,1,'2012-04-08 22:50:53',0,1,0,0),(3,3,1,3,'2012-04-08 23:03:21','192.168.30.20',1,0,1,1,'2012-04-08 23:03:21',0,1,0,0);
...
CREATE TABLE `jforum_roles` (
  ...
  KEY `idx_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='Users may bid for or sell auction items.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jforum_sessions` VALUES ('FCEDC6F5C2800D96D6E9422FFF48616E',2,'2012-04-08 22:55:15',0,'',0,NULL),('6D5B251FC37928949D5F401AEF9731BB',3,'2012-04-08 23:01:12',0,'',0,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='Users may bid for or sell auction items.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jforum_topics` VALUES (1,1,'欢迎使用iforums论坛系统',2,'2005-01-04 16:59:54',2,0,0,0,0,1,1,0,0),(2,1,'hello',2,'2012-04-08 22:50:53',9,0,0,0,0,2,2,0,0),(3,1,'sds',3,'2012-04-08 23:03:21',3,0,0,0,0,3,3,0,0);
...
INSERT INTO `jforum_topics_watch` VALUES (2,2,1),(3,3,1);
...
INSERT INTO `jforum_users` VALUES (1,NULL,'游客','nopass',0,0,NULL,'2012-04-08 22:48:32',NULL,0,'',NULL,'','%d/%M/%Y %H:%i',0,0,NULL,NULL,0,1,0,1,1,1,1,1,1,0,0,1,1,0,NULL,0,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL),(2,NULL,'admin','21232f297a57a5a743894a0e4a801fc3',0,0,NULL,'2012-04-08 22:48:32',NULL,2,'',NULL,'','%d/%M/%Y %H:%i',0,0,NULL,NULL,0,1,0,1,1,1,1,1,1,0,0,1,1,0,NULL,0,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,5,NULL),(3,1,'aa','4124bc0a9335c27f086f24ba207a4912',0,0,NULL,'2012-04-08 23:01:12',NULL,1,'',NULL,'','%d/%M/%Y %H:%i',0,0,NULL,NULL,0,1,0,1,1,1,1,1,1,0,0,1,1,0,NULL,0,'aa@aa.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL);
...
-- Dump completed on 2012-04-10 17:58:07
